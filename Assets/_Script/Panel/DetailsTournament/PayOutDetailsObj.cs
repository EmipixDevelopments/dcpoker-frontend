...
public class PayOutDetailsObj : MonoBehaviour
{
...
*/
    ...
    public GetpayoutDetails Datavalue;
    ...
    public void SetData(GetpayoutDetails Data, int i)// (RoomsListing.Room data, int i)
    {
        this.Datavalue = Data;
